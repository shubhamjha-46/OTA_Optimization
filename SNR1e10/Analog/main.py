...
def train(args, model, device, train_loader, optimizer, epoch, trainloss, cn):
    ...
    for batch_idx, (data, target) in enumerate(train_loader): 
        ...
        np.savetxt("train_loss_anlg_1e10_SNR_rot_RCD.csv", trainloss, delimiter =", ", fmt ='% s')   
...
def test(model, device, test_loader,accr):
    ...
    np.savetxt("accuracy_anlg_1e10_SNR_rot_RCD.csv", accr, delimiter =", ", fmt ='% s')
